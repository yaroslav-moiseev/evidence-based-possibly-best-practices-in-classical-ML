...
Рисунок 7. Рисунок 6. Визуализация датасета в двухмерном пространстве с выделением выбросов. 0 и 1, отрицательный и положительный классы соответственно. 2 – выбросы.
