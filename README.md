...
Хорошим вариантом для сравнения алгоритмов является тест Макнемара, однако, датасет не очень большой, а для тестовых данных изначально было выделено только 15%, в таком случае тест Макнемара не лучший вариант. Для небольших датасетов рекомендуется использовать вложенную кросс-валидиацию или 5x2cvf-тест **[19]**.
